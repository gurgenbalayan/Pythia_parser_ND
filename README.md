# Проект Pythia Parser North Dakota
...
После установки всех зависимостей и настройки переменных окружения, запускаем скрипт `Pythia_parser_ND.py`:

```bash
python Pythia_parser_ND.py
```
